...
/**
 * Disposisi_smSearch represents the model behind the search form of `app\models\Disposisi_sm`.
 */
class Disposisi_smSearch extends Disposisi_sm
{
    /**
     * {@inheritdoc}
     */
