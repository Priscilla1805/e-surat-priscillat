...
/**
 * Approval_skSearch represents the model behind the search form of `app\models\Approval_sk`.
 */
class Approval_skSearch extends Approval_sk
{
    /**
     * {@inheritdoc}
     */
