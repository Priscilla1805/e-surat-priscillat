...
/**
 * Approval_reSearch represents the model behind the search form of `app\models\Approval_re`.
 */
class Approval_reSearch extends Approval_re
{
    /**
     * {@inheritdoc}
     */
