...
/**
 * Surat_keluarSearch represents the model behind the search form of `app\models\Surat_keluar`.
 */
class Surat_keluarSearch extends Surat_keluar
{
    /**
     * {@inheritdoc}
     */
